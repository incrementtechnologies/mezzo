    ...
    <div class="item">
      <div class="item-content">
        ...
        <div class="details">
          ...
          <p v-if="active < 2">
            For inquiries, please contact us through <a :href="'tel:' + common.APP_PHONE_NUMBER" style="color: #fff;">{{common.APP_PHONE_NUMBER}}</a>, <a :href="'mailto:' + common.APP_EMAIL + '?Subject=INQUIRE'" target="_top" style="color: #fff;">{{common.APP_EMAIL}}</a> or order now on messenger <br/><a :href="'mailto:' + common.APP_MESSENGER + '?Subject=INQUIRE'" target="_top" style="color: #fff;">{{common.APP_MESSENGER}}</a>
          </p>
          <p v-if="active === 2">
